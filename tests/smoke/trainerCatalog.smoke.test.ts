...
describe('каталог тренажёра: инварианты', () => {
  ...
  it('страница «Все задачи» выбирает каталог без фиксированного лимита', async () => {
    ...
    expect(source, 'на странице остался запрос с фиксированным limit').not.toMatch(/limit: \d+/)
  })
